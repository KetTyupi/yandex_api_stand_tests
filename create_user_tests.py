...
def test_create_user_2_letter_in_first_name_get_success_response():
    positive_assert("Aaaaaaaaaaaaaa")
...
def negative_assert_no_first_name(user_body):
    ...
    assert_user_response.status_code == 400
    assert response.json()["code"] == 400
    assert response.json()["message"] == "Не все необходимые данные были переданы"
...
def test_create_user_number_type_first_name_get_error_response(user_body):
